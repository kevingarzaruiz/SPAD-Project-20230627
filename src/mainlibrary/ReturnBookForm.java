...
public class ReturnBookForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     int UserIDV;
       ...
       // I am setting up a try catch to accept only valid User and book ID´s
    try {
        BookIDV = Integer.parseInt(BookID.getText());
        UserIDV = Integer.parseInt(UserID.getText());
    } catch(NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "Please enter a valid User ID and Book ID.");
        return; // This stops further execution of the method
    }
